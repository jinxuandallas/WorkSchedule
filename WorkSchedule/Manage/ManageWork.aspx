<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageWork.aspx.cs" Inherits="WorkSchedule.Manage.ManageWork" MasterPageFile="~/MasterPage/MainSite.Master" %>

<asp:Content ID="ContentSchedule" ContentPlaceHolderID="ContentPlaceHolderTop" runat="server">
    <span style="text-align: left; font-size: x-large">批量处理工作任务</span>
    ...
    <div style="font-size: small">
        ...
        <br />
        &nbsp;&nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="SELECT [Id],CAST(序号 AS nvarchar)+ ' ' + [目标名称] as 目标名称, [目标内容] FROM [工作] WHERE ([年份] = @年份) order by 序号">
            <SelectParameters>
