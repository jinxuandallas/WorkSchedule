<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportGreenCity.aspx.cs" Inherits="WorkSchedule.Report.ReportGreenCity"  MasterPageFile="~/MasterPage/MainSite.Master" %>
...
<asp:Content ID="ContentSchedule" ContentPlaceHolderID="ContentPlaceHolderTop" runat="server">
    ...
    <div>
        ...
        <asp:Repeater ID="RepeaterSchedule" runat="server" OnItemDataBound="RepeaterSchedule_ItemDataBound" DataSourceID="SqlDataSource1" DataMember="DefaultView" OnItemCommand="RepeaterSchedule_ItemCommand">
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td style="text-align: center; font-size: xx-large">“绿色建设科技城”示范片区重点项目</td>
                    </tr>
                    <tr>
            ...
            <ItemTemplate>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <span style="font-size: small">责任领导：<%# ss.GetWorkLeaders(Guid.Parse( Eval("ID").ToString())) %></span><br /><span style="font-size: small"><%#Eval("备注").ToString().Trim()==""?"":"备注："+Eval("备注")+"<br />" %></span>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="SELECT Id, 序号, 目标名称,备注  FROM 绿色建设科技城 WHERE (年份 = @year) order by 序号" ProviderName="<%$ ConnectionStrings:ConnectionString1.ProviderName %>">
            <SelectParameters>
