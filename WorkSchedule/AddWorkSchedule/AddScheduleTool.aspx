...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            项工作：<asp:SqlDataSource ID="SqlDataSourceDropDownListWork" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="SELECT 序号, Id FROM 工作 WHERE (年份 = DATENAME(YYYY,GETDATE()) )">
            </asp:SqlDataSource>
            ...
            <asp:Repeater ID="Repeater1" runat="server" DataSource="<%#t.GetWeeksOfMonth(0,int.Parse(DropDownListMonth.SelectedValue)) %>" >
                ...
                <FooterTemplate><asp:Button ID="ButtonSubmit" runat="server" Text="提交" OnClick="ButtonSubmit_Click" /></FooterTemplate>
            </asp:Repeater>
        </div>
    </form>
</body>
